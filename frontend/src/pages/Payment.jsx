...
const FREE_FEATURES = [
  { text: '5 note uploads every 6 hours', locked: false },
  { text: '5 quiz questions per note', locked: false },
  { text: 'Basic AI summarization', locked: false },
  { text: 'Exam countdown', locked: false },
  { text: 'Study groups', locked: false },
  { text: 'Math Solver', locked: true },
  { text: 'Full AI summarization', locked: true },
  { text: 'Unlimited uploads', locked: true },
  { text: '50+ quiz questions', locked: true },
];

function StepIndicator({ step }) {
  const steps = ['Choose Plan', 'Pay', 'Done'];
  return (
    ...
    <div className="space-y-4">
      <div className="text-center">
        ...
        <p className="text-gray-500 text-sm mt-1">
          All prices in FCFA — Pay with Mobile Money
        </p>
      </div>
      ...
      <div className="bg-gray-50 rounded-2xl border border-gray-200 p-4">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-bold text-gray-700">Current: Free Plan</h3>
        ...
        <div className="grid grid-cols-1 gap-1">
          {FREE_FEATURES.map((feature, i) => (
            <div key={i} className="flex items-center gap-2 text-sm">
              ...
              <span className={feature.locked ? 'text-gray-400 line-through' : 'text-gray-600'}>
                {feature.text}
              </span>
            </div>
          ))}
    ...
    <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="mt-3 space-y-1">
                <p className="text-red-500 text-xs font-bold">How to top up:</p>
                {selectedMethod === 'mtn' ? (
                  <ul className="text-xs text-red-500 space-y-0.5">
                    <li>• Dial *126# on your MTN phone</li>
                    <li>• Select Deposit Money</li>
                    <li>• Go to any MTN MoMo agent near you</li>
                  ...
                  <ul className="text-xs text-red-500 space-y-0.5">
                    ...
                    <li>• Go to any Orange Money agent near you</li>
                    <li>• Top up at least {plan.price} FCFA then try again</li>
                  </ul>
                )}
              </div>
      ...
      >
        <div className="flex items-center gap-4 p-4">
          ...
          >
            <p className="font-black text-blue-900 text-xl leading-none tracking-wider">
              MTN
            </p>
            <p className="text-blue-900 text-xs font-bold leading-none mt-0.5">
              MoMo
            </p>
          </div>
          <div className="flex-1 text-left">
            ...
            <p className="text-yellow-600 text-xs font-medium mt-0.5">
      ...
      {selectedMethod && (
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-2">
            Enter your 9-digit number without country code
          </p>
        </div>
      )}
      ...
      <div className="flex gap-3">
        <button
          onClick={() => setStep(1)}
          className="px-5 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold rounded-xl transition flex-shrink-0"
        >
          ← Back
        </button>
        <button
  ...
  return (
    <div className="bg-white rounded-2xl p-8 shadow-sm text-center border border-gray-100">
      ...
      <p className="text-gray-500 text-sm mb-6">
        Check your phone and approve the{' '}
      ...
      <div className={`rounded-xl p-4 mb-4 ${
        ...
        <p className={`text-sm font-medium ${
          selectedMethod === 'mtn' ? 'text-yellow-700' : 'text-orange-700'
        }`}>
          ⏳ Your account will upgrade to Pro automatically within
          5 minutes after payment confirmation.
        </p>
      </div>
      ...
      <div className="bg-gray-50 rounded-xl p-4 mb-6 text-left space-y-2">
        ...
        {[
          ...
          'Your account upgrades to Pro automatically',
        ].map((step, i) => (
      ...
      <div className="bg-white shadow-sm px-4 md:px-8 py-4 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">
            No credit card needed — Pay with Mobile Money
          </p>
        </div>
      </div>
